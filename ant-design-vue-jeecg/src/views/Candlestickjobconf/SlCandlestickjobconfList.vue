        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item>
                <a-popconfirm title="确定本次抓取数据任务吗?" @confirm="() => handleCrawl(record.jobid)">
                  <a>抓取数据</a>
                </a-popconfirm>
                </a-menu-item>
            </a-menu>
...
<script>
  ...
  export default {
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            customRender:  (text) => {
              //字典值翻译通用方法
              return filterDictTextByCache('market_code', text);
            }
          },
          {
            title:'股票代码',
          ...
          },
          {
            ...
            customRender:  (text) => {
              //字典值翻译通用方法
              return filterDictTextByCache('kcp', text);
            }
          },
          {
            title:'开始日期',
        ...
        url: {
          ...
          crawlData:"/candlestickjobconf/slCandlestickjobconf/crawlData",
        },
        dictOptions:{},
        superFieldList:[],
      }
    ...
    methods: {
      ...
      ,
      handleCrawl(jobId){
        if(!this.url.crawlData){
          this.$message.error("请设置url.crawlData属性!")
          return
        }
        let that = this;
        getAction(that.url.crawlData, {jobId: jobId}).then((res) => {
          if (res.success) {
